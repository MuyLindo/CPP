...
и 26 години включително, като се предефинира операцията <<.Данните да се съхраняват във файл.
**/
...
Student::Student(string name, string facNumber, Date date, double average){
    this -> name = name;
...
int main()
{
    ...
    Student student5("He2", "121216152", date6, 4.65);
    ...
    for(unsigned int i = 0; i< arr.size(); i++){
        ...
        if(arr[i].age(date5) >= 18 && arr[i].age(date5) <= 26){
